...
/**
 * Provides the local service interface for MigrationManager. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Dylan Rebelak
 * @see MigrationManagerLocalServiceUtil
...
public interface MigrationManagerLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MigrationManagerLocalServiceUtil} to access the migration manager local service. Add custom service methods to {@link com.liferay.data.migration.tool.service.impl.MigrationManagerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public MigrationManager addMigrationManager(
	...
	*/
	public MigrationManager createMigrationManager(long managerId);
	...
	*/
	...
	public MigrationManager deleteMigrationManager(
		MigrationManager migrationManager);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public MigrationManager deleteMigrationManager(long managerId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MigrationManager fetchMigrationManager(long managerId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MigrationManager getMigrationManager(long managerId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public MigrationManager updateMigrationManager(
		MigrationManager migrationManager);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MigrationManager> getMigrationManagers(int start, int end);
