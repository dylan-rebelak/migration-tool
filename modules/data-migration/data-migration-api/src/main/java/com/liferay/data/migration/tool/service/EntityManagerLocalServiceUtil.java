 ...
 * {@link com.liferay.data.migration.tool.service.impl.EntityManagerLocalServiceImpl} and is the
 ...
 * @see com.liferay.data.migration.tool.service.base.EntityManagerLocalServiceBaseImpl
...
public class EntityManagerLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.data.migration.tool.service.impl.EntityManagerLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.data.migration.tool.model.EntityManager addEntityManager(
	...
	*/
	public static com.liferay.data.migration.tool.model.EntityManager createEntityManager(
		java.lang.String entityName) {
		return getService().createEntityManager(entityName);
	}
	...
	*/
	public static com.liferay.data.migration.tool.model.EntityManager deleteEntityManager(
		com.liferay.data.migration.tool.model.EntityManager entityManager) {
	...
	*/
	public static com.liferay.data.migration.tool.model.EntityManager deleteEntityManager(
		...
		return getService().deleteEntityManager(entityName);
	}

	public static com.liferay.data.migration.tool.model.EntityManager fetchEntityManager(
		java.lang.String entityName) {
		return getService().fetchEntityManager(entityName);
	}
	...
	* @throws PortalException if a entity manager with the primary key could not be found
	*/
	public static com.liferay.data.migration.tool.model.EntityManager getEntityManager(
		java.lang.String entityName)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getEntityManager(entityName);
	}
	...
	*/
	public static com.liferay.data.migration.tool.model.EntityManager updateEntityManager(
		com.liferay.data.migration.tool.model.EntityManager entityManager) {
	...
	*/
	public static java.util.List<com.liferay.data.migration.tool.model.EntityManager> getEntityManagers(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<EntityManagerLocalService, EntityManagerLocalService> _serviceTracker =
		ServiceTrackerFactory.open(EntityManagerLocalService.class);
}