...
/**
 * Provides the local service interface for EntityManager. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Dylan Rebelak
 * @see EntityManagerLocalServiceUtil
...
public interface EntityManagerLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EntityManagerLocalServiceUtil} to access the entity manager local service. Add custom service methods to {@link com.liferay.data.migration.tool.service.impl.EntityManagerLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public EntityManager createEntityManager(java.lang.String entityName);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public EntityManager deleteEntityManager(java.lang.String entityName)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public EntityManager fetchEntityManager(java.lang.String entityName);
